...
backbone_model = net = efn.EfficientNetB3(include_top=False, weights='imagenet', input_tensor=None, input_shape=IM_SIZE)
...
# reload callback
# check_point_path = 'models/efn/EfficientNetB3.ckpt'
# check_point_path = 'models/efn_guiyihua/EfficientNetB3.ckpt'
# check_point_path = 'models/efn_more_dense/EfficientNetB3.ckpt'
# check_point_path = 'models/efn_more_dense_no_pretrained/EfficientNetB3.ckpt'
# check_point_path = 'models/efn_more_dense_no_pretrained_new_img/EfficientNetB3.ckpt'
# check_point_path = 'models/efn_more_dense_no_pretrained_new_img_15s/EfficientNetB3.ckpt'
# define callback
check_point_path = 'models/efn_more_dense_no_pretrained_new_img_5s/EfficientNetB3.ckpt'
...
df.to_csv('submit_10s_model_EfficientNetB3_10s_guiyihua_maxvote.csv', index=False, header=False)

df = pd.Series(answer_list_prob)
df.to_csv('submit_10s_model_EfficientNetB3_10s_guiyihua_maxprob.csv', index=False, header=False)
