...
backbone_model = efn.EfficientNetB3(include_top=False, input_tensor=None, input_shape=IM_SIZE)
...
tensorboard_log_path = 'logs/efn_split_10s_more_dense_no_pretrained_new_img_5s/'
