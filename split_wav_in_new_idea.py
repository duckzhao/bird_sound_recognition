# 将训练集中的wav文件 以15s 为单位进行子wav文件的切分,每次递进5s
...
if __name__ == '__main__':
    split_duration = 15000
    step_duration = 5000

    train_base_path = 'train_split_data_15_5s'
    dev_base_path = 'dev_split_data_15_5s'
    run_split(train_voice_path_dict, train_base_path)
    run_split(dev_voice_path_dict, dev_base_path)
    test_base_path = 'test_split_data_15_5s'
